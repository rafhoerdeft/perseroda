...
Route::middleware('preventBackHistory')->prefix('produk')->name('produk.')->namespace('App\Http\Controllers')->group(function () {
    ...
    Route::get('add', 'Produk@add')->name('add')->middleware('auth.user:akuntansi;bendahara;kasir');
    Route::get('edit/{id?}', 'Produk@edit')->name('edit')->middleware('auth.user:akuntansi;bendahara;kasir');
    Route::post('delete', 'Produk@delete')->name('delete')->middleware('auth.user:akuntansi;bendahara;kasir');
    Route::post('save', 'Produk@save')->name('save')->middleware('auth.user:akuntansi;bendahara;kasir');
});
