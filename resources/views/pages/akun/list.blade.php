        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form class="row g-3" method="POST" action="{{ url('akun/store') }}">
                        @csrf
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="pegawai_id" id="pegawai_id" class="@error('pegawai_id') is-invalid @enderror">
                                @foreach ($pegawai as $item)
                                    <option value="{{ encode($item->id) }}"
                                        {{ isset($user) && ($user->pegawai_id = $item->id ? 'selected' : '') }}>
                            ...
                            <tbody>
                                ...
                                @foreach ($list_data as $row)
                                    <tr>
                                        ...
                                        @if ($is_role)
                                            ...
                                            <td>
                                                <button data-id="{{ encode($row->id) }}"
                                                    data-username="{{ $row->username }}" data-role="{{ $row->role_id }}"
                                                    onclick="editData(this)" class="btn btn-info btn-sm"
                                                    title="Update Data">
                                        ...
                                        <td>{{ $row->username }}</td>
                                        <td>{{ ucfirst($row->role->nama_role) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
