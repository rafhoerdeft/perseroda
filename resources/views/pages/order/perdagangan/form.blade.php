                    ...
                    <form class="row g-3" method="POST" action="{{ url('order/perdagangan/save') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row" id="status_bayar">
                                ...
                                <div class="col-md-4">
                                    <input class="btn-check" type="radio" name="status_bayar" id="belum_bayar"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="hidden" class="form-control" id="tot_bayar_input" name="tot_bayar" value="0">
...
@push('js_script')
    ...
    <script>
        function getDataBarang() {
            ...
            try {
                ...
                $.get("{{ route('order.perdagangan.barang') }}", {
                    ...
                    if (data.response) {
                        var res = addRincianDataToInput(data.result.kode_barang, jml);
                        if (res.key_exist) {
        ...
        function addRincianDataToInput(kode, jml, add_prev_val = true) {
            var rincian_barang = $('#rincian_barang').val();

            var key_exist = false;
            if (rincian_barang != '') {
                var obj_rincian = JSON.parse(rincian_barang);
                if (kode in obj_rincian) {
                    key_exist = true;
                    if (add_prev_val) {
                        jml += obj_rincian[kode];
                    }
                }
            }
        ...
        function updateTotal(data) {
            ...
            addRincianDataToInput(kode, parseInt(jml), false);
