...
@section('content')
    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body p-5">
            ...
            <hr>
            <form class="row g-3" method="POST" action="{{ url('transaksi/in/percetakan/save') }}">
                @csrf
                ...
                <div class="col-md-6"
                    style="display: {{ old('lampiran_konsep') != null ? (old('lampiran_konsep') == '1' ? 'block' : 'none') : (isset($order) ? ($order->rincian_cetakan->lampiran_konsep == '1' ? 'block' : 'none') : 'block') }}">
