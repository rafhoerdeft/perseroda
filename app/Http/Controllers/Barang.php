...
class Barang extends UserBaseController
{
    public function index()
    {
        $breadcrumb = ['Stok Barang'];
        $list_barang = BarangModel::with('tarif:harga,barang_id')->orderByDesc('id')->get();
    ...
    {
        $barang = BarangModel::with('tarif:harga,barang_id')->find(decode($id));
        $breadcrumb = ['barang' => 'Stok Barang', 'Form Barang']; //url => title
